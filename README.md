...
**Four Hands** — Software Engineer Intern (January 2025 – May 2025)

**SHI International Corp.** — Software Engineer Intern (May 2024 – January 2025)
...
**Databases:** PostgreSQL, MSSQL, SQLite, Firestore

**Tools:** Git, JFrog Artifactory, Swagger, Postman
...
- Leading 3-person Agile team with 100% sprint completion rate

**LLM Sanitizer Agent** — BokoHacks 2025
- Spam-registration flagging system using Google Gemini LLM for input sanitization
- Increased application security by 75% through intelligent anomaly detection
- Tech: Python, Flask, Gemini API, SQLite, MailGun
